...
var _restaurantViewJs = require("./views/restaurantView.js");
var _restaurantViewJsDefault = parcelHelpers.interopDefault(_restaurantViewJs);
...
const controlResults = async function(query) {
    try {
        // match query with id
        const id = await _modelJs.matchQuery(query);
        // Go to results page
        (0, _searchViewJsDefault.default).switchPage();
        (0, _resultsViewJsDefault.default).renderSpinner();
        // Get position and load results
        await _modelJs.getPosition(id);
        console.log(_modelJs.state.search);
        // Render results
        (0, _resultsViewJsDefault.default).render(_modelJs.state.search);
        (0, _resultsViewJsDefault.default).resultsCount(query, _modelJs.state.search.results.length);
    } catch (err) {
        // Maybe alert
        console.log(err);
    }
...
const controlRestaurants = async function(id) {
    try {
        // 1) Find rest
        await _modelJs.matchRest(id);
        console.log(_modelJs.state.rest);
        // 2) Render rest page
        (0, _restaurantViewJsDefault.default).render(_modelJs.state.rest);
        (0, _restaurantViewJsDefault.default).renderMap();
        // 3) Switch page
        (0, _resultsViewJsDefault.default).switchPage();
    } catch (err) {
        console.log(err);
    }
};
...
const controlResultsSearch = async function() {
    ...
    if (!query) return;
    (0, _searchViewJsDefault.default).toggleSpinner();
    await controlResults(query);
    (0, _searchViewJsDefault.default).toggleSpinner();
};
const controlResultsRdm = async function() {
    // 1) Get random query
    const query = await _modelJs.matchQuery("random", true);
    // 2) Render results
    await controlResults(query);
};
...
const controlFilters = async function(filter, checked = false) {
    _modelJs.applyFilters(filter);
    if (!checked) _modelJs.revertResults();
    console.log(_modelJs.state.search.results, _modelJs.state.search.oriResults, checked);
    (0, _resultsViewJsDefault.default).render(_modelJs.state.search);
};
const controlAbout = function() {
    (0, _aboutViewJsDefault.default).switchPage();
};
const init = function() {
    (0, _searchViewJsDefault.default).addHandlerSearch(controlResultsSearch);
    (0, _resultsViewJsDefault.default).addHandlerClick(controlRestaurants);
    (0, _resultsViewJsDefault.default).addHandlerFilter(controlFilters);
    (0, _homeViewJsDefault.default).addHandlerCat(controlResultsCat);
    (0, _homeViewJsDefault.default).addHandlerTop(controlTopRests);
    (0, _homeViewJsDefault.default).addHandlerRdm(controlResultsRdm);
    (0, _aboutViewJsDefault.default).addHandlerAbout(controlAbout);
};
console.log("apsps");
init();

},{"core-js/modules/es.array.includes.js":"dkJzX","core-js/modules/es.regexp.flags.js":"gSXXb","core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","regenerator-runtime":"dXNgZ","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/restaurantView.js":"ihfiq","./views/homeView.js":"kxSlf","./views/aboutView.js":"jVrhK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dkJzX":[function(require,module,exports) {
"use strict";
...
},{"ffa5d46bdab873f9":"dIGt4","abe71b6f5a2c149":"n5IsC","9a828f869e1adf81":"jx7ej"}],"dIGt4":[function(require,module,exports) {
...
var global = require("9cdb65608dfb6cb0");
...
},{"9cdb65608dfb6cb0":"i8HOC","7ba7e65983d7b662":"7GlkT","df551e12a7c872dd":"hL6D2","1d34ea813cebff9c":"bdfmm"}],"7GlkT":[function(require,module,exports) {
...
var global = require("aadfbfc429be7216");
...
},{"aadfbfc429be7216":"i8HOC"}],"5XWKd":[function(require,module,exports) {
...
var global = require("99178678bc7a711a");
...
},{"99178678bc7a711a":"i8HOC","70235907dc93b4b0":"d7JlP","46fb53dace408c8e":"Z0pBo","677bdc4d74d2f983":"4aV4F","80395bcde336a28b":"9Zfiw","49552a7324952190":"7MME2","aea01c71276624bf":"gTwyA"}],"Z0pBo":[function(require,module,exports) {
...
var global = require("3003ac5e19a9d37");
...
},{"3003ac5e19a9d37":"i8HOC","6b6c481cdfb7df35":"6ZUSY","2af44fcbdbf14c83":"l3Kyn","76e903e830c40e7c":"3jtKQ","7e2fe930b3598e22":"2Ye8Q"}],"6ZUSY":[function(require,module,exports) {
...
/* eslint-disable es/no-symbol -- required for testing */ var NATIVE_SYMBOL = require("a5910da293cb63f6");
module.exports = NATIVE_SYMBOL && !Symbol.sham && typeof Symbol.iterator == "symbol";

},{"a5910da293cb63f6":"grUXC"}],"grUXC":[function(require,module,exports) {
/* eslint-disable es/no-symbol -- required for testing */ var V8_VERSION = require("677a9f52d6ca4bb0");
...
},{"677a9f52d6ca4bb0":"bjFlO","c154b223d883c4d1":"hL6D2"}],"bjFlO":[function(require,module,exports) {
...
},{"16054ed539401f1":"6ZUSY"}],"9Zfiw":[function(require,module,exports) {
...
},{"bbfed17b24e215f4":"gOMir"}],"gOMir":[function(require,module,exports) {
var global = require("73df398b2b453fec");
...
},{"73df398b2b453fec":"i8HOC","4094667126ecac05":"l3Kyn","fce2a7573db493fa":"4O7d7"}],"4O7d7":[function(require,module,exports) {
var global = require("96da248a1c47aa32");
...
},{"96da248a1c47aa32":"i8HOC"}],"7MME2":[function(require,module,exports) {
var global = require("4a0e4a1baf2af8c2");
...
},{"4a0e4a1baf2af8c2":"i8HOC","abe9ca006f56626e":"d7JlP","c96b3a89fec6248a":"l3Kyn","551615fda0214f1b":"Z0pBo"}],"gTwyA":[function(require,module,exports) {
...
},{"dbe74e87464035e3":"i8HOC","6a2cda01df6b4c79":"i1mHK","dccc28ffa5beeb54":"gC2Q5","48d6af1225853d44":"a3SEE","12ccc61b0bbd074c":"grUXC","1ce268781e409df2":"2Ye8Q"}],"i1mHK":[function(require,module,exports) {
...
},{"4785828acf653da3":"i8HOC"}],"gC2Q5":[function(require,module,exports) {
...
var global = require("587c79a917566803");
...
},{"587c79a917566803":"i8HOC","f45a7b5dcdc4a410":"fOR0B"}],"a3SEE":[function(require,module,exports) {
...
var global = require("6d3200cf9dace7d0");
...
},{"6d3200cf9dace7d0":"i8HOC","ca50eb9163928400":"92ZIi","d482f9e5478795e8":"qS9uN","b6ad7537efb06f4b":"ka1Un","16365a73399e7fe7":"4isCr","fab1d366c47796d9":"5XWKd"}],"ka1Un":[function(require,module,exports) {
...
var global = require("355d917d7054c153");
...
},{"355d917d7054c153":"i8HOC","2b6c6258a0a6082f":"Z0pBo"}],"1ZKnU":[function(require,module,exports) {
var global = require("ad29211ac7a99cf3");
var isCallable = require("3cfec941a7f48f72");
var hasOwn = require("8bc80a88e96e9b1e");
...
var CONFIGURABLE_FUNCTION_NAME = require("bc6c6c2ee1bed92c").CONFIGURABLE;
...
},{"ad29211ac7a99cf3":"i8HOC","3cfec941a7f48f72":"l3Kyn","8bc80a88e96e9b1e":"gC2Q5","fb5c982780275e5e":"8CL42","1111dde9b567f8a1":"ldqR5","3e459da4f22431a3":"9jh7O","78b34e0c633bdce7":"7AMlF","bc6c6c2ee1bed92c":"l6Kgd"}],"9jh7O":[function(require,module,exports) {
...
var uncurryThis = require("3cf24bfdcfe2212f");
...
},{"f0a2bf6263225aee":"7LdJl","ca46b44b6201ccd7":"i8HOC","3cf24bfdcfe2212f":"7GlkT","f82e6cc0ac249fa5":"Z0pBo","c0ae163eea4ef97":"8CL42","6dea7358344877bb":"gC2Q5","3e035a1241da2f0":"l4ncH","88d6ccc27e779e5a":"eAjGz","d40b9b3abdbb956e":"661m4"}],"7LdJl":[function(require,module,exports) {
var global = require("6e8e91a63fc6bed5");
var isCallable = require("652e829718ea2acf");
var inspectSource = require("b3ae89ce7d946b9c");
var WeakMap = global.WeakMap;
module.exports = isCallable(WeakMap) && /native code/.test(inspectSource(WeakMap));

},{"6e8e91a63fc6bed5":"i8HOC","652e829718ea2acf":"l3Kyn","b3ae89ce7d946b9c":"9jh7O"}],"eAjGz":[function(require,module,exports) {
...
},{"8ad2bacb0e20b95c":"92ZIi","4eabfd8f83afc9d5":"gC2Q5"}],"9Z12i":[function(require,module,exports) {
...
},{"10299561ea0c7870":"hL6D2","8b1ecdaf59f07210":"l3Kyn"}],"jx7ej":[function(require,module,exports) {
...
},{"14cb391fa4a0dda8":"6ZUSY"}],"gSXXb":[function(require,module,exports) {
var DESCRIPTORS = require("32574bd865b8e6e5");
var objectDefinePropertyModule = require("8aa3b75de9d2e567");
...
},{"32574bd865b8e6e5":"92ZIi","8aa3b75de9d2e567":"iJR4w","67e6b6bed174b69b":"9bz1x","f4050f72fe5dda92":"hL6D2"}],"9bz1x":[function(require,module,exports) {
"use strict";
...
},{"136abace0aec2b5c":"4isCr"}],"49tUX":[function(require,module,exports) {
...
},{"1e8ed58235e9956a":"i8HOC","e574be68c288c7c8":"148ka","df212787338802d3":"7vpmS","afdf018c2d01bbc6":"l3Kyn","35a3e849940fd612":"gC2Q5","b8bf5434d2248ca7":"hL6D2","731f9370cc21fc3b":"2pze4","ec358060964e4bde":"RsFXo","907adb6d219da7a3":"4bOHl","fdfdeccf85e81d4f":"bzGah","fcf929779abbf29c":"2Jcp4"}],"148ka":[function(require,module,exports) {
var FunctionPrototype = Function.prototype;
...
var uncurryThis = require("239b95ec6c7aa699");
...
},{"239b95ec6c7aa699":"7GlkT","547ee4f9dab0cc76":"gOMir"}],"RsFXo":[function(require,module,exports) {
var uncurryThis = require("5250b5c9324ccbe");
module.exports = uncurryThis([].slice);

},{"5250b5c9324ccbe":"7GlkT"}],"bzGah":[function(require,module,exports) {
...
},{"779f783a397f138":"bdfmm","1b4555a3a97d5ef1":"i8HOC"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "matchQuery", ()=>matchQuery);
parcelHelpers.export(exports, "matchRest", ()=>matchRest);
parcelHelpers.export(exports, "getPosition", ()=>getPosition);
parcelHelpers.export(exports, "loadSearchResults", ()=>loadSearchResults);
parcelHelpers.export(exports, "applyFilters", ()=>applyFilters);
parcelHelpers.export(exports, "revertResults", ()=>revertResults);
...
const matchQuery = async function(query, top = false) {
    // let url = '';
    // if (top)
    //   url = `${API_URL}list?location_id=297474&lunit=km&open_now=false&lang=${navigator.language}`;
    // else
    //   url = `${API_URL}list?location_id=297474&lunit=km&open_now=false&lang=${navigator.language}`;
    const data = await (0, _helperJs.AJAX)(`${(0, _configJs.API_URL)}list?location_id=297474&lunit=km&open_now=false&lang=${navigator.language}`, true);
    state.search.query = query;
    console.log(data.filters_v2.filter_sections[1].filter_groups[0].options, "pepe");
    if (top) return data.filters_v2.filter_sections[1].filter_groups[0].options[Math.floor(Math.random() * 77)].label;
    const match = data.filters_v2.filter_sections[1].filter_groups[0].options.filter((filt)=>filt.label.toLowerCase().includes(query.toLowerCase())).map((val)=>val.value);
    return match;
};
const matchRest = async function(id) {
    const data = await (0, _helperJs.AJAX)(`${(0, _configJs.API_URL)}get-details?location_id=${id}&lang=${navigator.language}`, true);
    console.log(data);
    state.rest = {
        title: data.name,
        lat: data.latitude,
        ...
        open: data.is_closed ? data.hours ? decimalToTime(data.hours.week_ranges[0][0].open_time) : "---" : 1,
        type: data.cuisine && data.cuisine.length && data.cuisine.map((type)=>type.name) || [
            "general"
        ],
        cost: data.price_level.replace(/\s/g, ""),
        hours: data.hours ? data.hours.week_ranges.map((hour)=>{
            if (hour.length === 0) return "00:00-00:00";
            return `${decimalToTime(hour[0].open_time / 60)}-${decimalToTime(hour[0].close_time / 60)}`;
        }) : "No schedule available for this restaurant",
        reviews: data.reviews ? data.reviews.map((rev)=>{
            return {
                title: rev.title,
                rating: rev.rating,
...
const getPosition = async function(query) {
...
const loadSearchResults = async function(pos, id) {
    try {
        if (!pos) throw new Error("Could not get your position, please allow it on your browser settings");
        const { latitude } = pos.coords;
        const { longitude } = pos.coords;
        const data = await (0, _helperJs.AJAX)(`${(0, _configJs.API_URL)}list-by-latlng?latitude=${latitude}&longitude=${longitude}&limit=30&combined_food=${id.join(",")}&open_now=false&lunit=km&lang=${navigator.language}`, true);
        console.log(data);
        state.search.results = data.data.map((res)=>{
            if (!res.name) return;
            return {
                id: res.location_id,
                title: res.name,
                ...
                rating: res.rating,
                open: res.is_closed ? res.hours ? decimalToTime(res.hours.week_ranges[0][0].open_time) : "---" : 1,
                type: res.cuisine && res.cuisine.length && res.cuisine.map((type)=>type.name) || [
                    "general"
                ],
...
const applyFilters = function(filter) {
    let value = "";
    if (filter === 0) state.search.results = state.search.results.sort((a, b)=>{
        if (a !== 1) return 1;
        if (b !== 1) return -1;
        return 0;
    });
    ...
    if (filter > 0) state.search.results = state.search.results.sort((a, b)=>value * a.rating - value * b.rating);
    if (filter < 0) state.search.results = state.search.results.sort((a, b)=>value * a.cost.length - value * b.cost.length);
};
const revertResults = function() {
...
const dateDifference = function(date) {
    ...
    //Minutes
    const diffMinutes = Math.abs(diffDates / 60000);
    // Hours
...
parcelHelpers.export(exports, "mapZoomLevel", ()=>mapZoomLevel);
const API_URL = "https://travel-advisor.p.rapidapi.com/restaurants/";
const TIMEOUT_SEC = 10;
const API_KEY = "d719966546msh01f8350fa5df501p11db35jsna1e9f142b9ed";
...
const AJAX = async function(url, headers) {
    try {
        const fetched = headers ? fetch(url, {
            method: "GET",
            headers: {
                "x-rapidapi-key": `${(0, _configJs.API_KEY)}`,
...
class SearchView {
    ...
    addHandlerSearch(handler) {
        this._parents.forEach((el)=>el.addEventListener("submit", (function(e) {
                e.preventDefault();
    ...
    toggleSpinner() {
        this._parentElement.querySelector(".fa-magnifying-glass").classList.toggle("off");
        this._parentElement.querySelector(".fa-circle-notch").classList.toggle("off");
    }
}
...
var _greyBgJpg = require("url:../../img/grey-bg.jpg");
var _greyBgJpgDefault = parcelHelpers.interopDefault(_greyBgJpg);
class ResultsView extends (0, _viewJsDefault.default) {
    ...
    _template(data) {
      ...
      <div class="object" data-id="${data.id}">
              <img src="${data.images ? data.images.original.url : `${0, _greyBgJpgDefault.default}`}" alt="" />
              <div class="details">
                ...
                <div class="aside_details">
                  <div class="available">
                    ...
                    <div class="sign ${!isNaN(data.open) ? "open" : "close"}"></div>
...
},{"./view.js":"bWlJ9","url:../../img/grey-bg.jpg":"bIhMP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bWlJ9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
    ...
    _ratingCalculator(rating) {
        const arr = [];
        for(let i = 0; i < Math.ceil(rating); i++)if (rating - (i + 1) >= 0) arr.push('<i class="fa-solid fa-star"></i>');
        else arr.push('<i class="fa-solid fa-star-half-stroke"></i>');
        while(arr.length < 5)arr.push('<i class="fa-regular fa-star"></i>');
        return arr;
    }
}
exports.default = View;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bIhMP":[function(require,module,exports) {
module.exports = require("9a95d4803d88722").getBundleURL("hWUTQ") + "grey-bg.5bb24553.jpg" + "?" + Date.now();

},{"9a95d4803d88722":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"ihfiq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _greyBgJpg = require("url:../../img/grey-bg.jpg");
var _greyBgJpgDefault = parcelHelpers.interopDefault(_greyBgJpg);
var _locationDotSolidSvg = require("url:../../img/location-dot-solid.svg");
var _locationDotSolidSvgDefault = parcelHelpers.interopDefault(_locationDotSolidSvg);
var _configJs = require("../config.js");
// import * as L from 'leaflet';
class RestaurantView extends (0, _viewJsDefault.default) {
    ...
    <section id="rest" class="container">
      ...
      <div class="rest-img">
        <img src="${this._data.images ? this._data.images.original.url : `${0, _greyBgJpgDefault.default}`}" alt="" />
      </div>
      <div class="rest-desc">
        <p>
  ...
  <section id="rest_info" class="container">
    ...
    <div id="schedule" class="figure">
      ...
      ${this._data.hours.length === 7 ? `<div class="day">
      <p>Monday</p>
  ...
  <section id="comments" class="container">
      <div class="comments-container py-2">
        ...
        ${this._data.reviews ? this._data.reviews.map((rev)=>this._generateMarkupReview(rev)).join("") : "No reviews for this restaurant yet"}
      </div>
    </section>
      `;
        return markup;
    ...
    renderMap() {
        ...
        this._map = L.map("map").setView(coords, (0, _configJs.mapZoomLevel));
...
exports.default = new RestaurantView();

},{"./view.js":"bWlJ9","url:../../img/grey-bg.jpg":"bIhMP","url:../../img/location-dot-solid.svg":"a2zZs","../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a2zZs":[function(require,module,exports) {
module.exports = require("8f1f8e6c7abc1aa4").getBundleURL("hWUTQ") + "location-dot-solid.9d9f264f.svg" + "?" + Date.now();

},{"8f1f8e6c7abc1aa4":"lgJ39"}],"kxSlf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"bWlJ9","url:../../img/grey-bg.jpg":"bIhMP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jVrhK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class AboutView extends (0, _viewJsDefault.default) {
    ...
    addHandlerAbout(handler) {
        this._parents.forEach((el)=>el.addEventListener("click", function(e) {
                e.preventDefault();
                handler();
            }));
    }
...
},{"./view.js":"bWlJ9","url:../../img/grey-bg.jpg":"bIhMP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire165e")
